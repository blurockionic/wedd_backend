...
import { addBlog, getBlogs, getBlogById, updateBlog, deleteBlog, getBlogsByTag, getBlogByUrlTitle, searchBlogs,getPublishedBlogs } from "../controllers/blogController/blog.controller.js";
...
// 🔒 **Admin Routes** (Only accessible by authenticated ADMIN users)
{
    ...
    blogRouteAdmin.get("/allBlog/", getBlogByUrlTitle); // Fetch a blog by url title
